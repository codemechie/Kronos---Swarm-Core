...
export function FractureAttribution({ agents }: Props) {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-card px-2 py-1.5 mb-2">
        <div className="text-2xs text-gray-500">PRIMARY CONTRIBUTOR</div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-900">{primary.displayName}</span>
          ...
          return (
            <div key={c.agentId} className="text-xs">
              <div className="flex items-center justify-between text-gray-500">
                ...
                <span className={isHighRisk ? "text-red-600 font-semibold" : "text-gray-500"}>
              ...
              <div className="w-full h-1 bg-gray-200 rounded mt-1 overflow-hidden">
                <div
                  className={`h-full rounded ${
                    isHighRisk ? "bg-red-500" : "bg-gray-400"
                  }`}
