...
export function GraniteTerminal() {
  ...
  if (granite_review.skipped) {
    return (
      <div className="border border-gray-700 rounded bg-gray-900 p-4 font-mono text-gray-100">
        <div className="text-xs tracking-widest text-gray-400 mb-1">GRANITE REVIEW TERMINAL</div>
        <div className="text-[10px] tracking-widest text-gray-600 mb-3">IBM GRANITE REVIEW LAYER</div>

        <div className="flex items-center justify-between mb-3">
          <span className="text-[10px] tracking-widest text-gray-500">STATUS</span>
        ...
        <div className="grid grid-cols-3 gap-3 border-t border-gray-700 pt-3 text-xs">
          <div>
            <div className="text-[10px] tracking-widest text-gray-500 mb-0.5">Current Confidence</div>
          ...
          <div>
            <div className="text-[10px] tracking-widest text-gray-500 mb-0.5">Current Fracture</div>
            <div className="text-sm font-semibold text-white">{swarmMetrics.fracture_index}</div>
          </div>
          <div>
            <div className="text-[10px] tracking-widest text-gray-500 mb-0.5">Current Agreement</div>
            <div className="text-sm font-semibold text-white">
