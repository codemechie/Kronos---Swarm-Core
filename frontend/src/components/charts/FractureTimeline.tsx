...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-card px-3 py-2 text-xs font-mono text-gray-700 max-w-56">
      ...
      {datum?.event && (
        <div className="mt-1.5 pt-1.5 border-t border-gray-200">
          <div className="text-gray-500 text-2xs mb-0.5">Event</div>
          <div
            className={
...
export function FractureTimeline() {
  ...
  return (
    <div className="border border-gray-200 rounded-card bg-white p-4 font-mono text-gray-900">
      <div className="text-xs tracking-widest text-green-600 font-semibold mb-1">
        FRACTURE TIMELINE
      </div>
      <div className="text-2xs text-gray-600/70 mb-4">
      ...
      <div className="flex items-center gap-5 mt-3 text-2xs text-gray-600">
