...
export function ValidationCenter() {
  ...
  if (!hasData) {
    return (
      <div className="border border-gray-700 rounded bg-gray-900 p-4 font-mono text-gray-100">
        <div className="text-xs tracking-widest text-gray-600 mb-3">VALIDATION CENTER</div>
  ...
  return (
    <div className="border border-gray-700 rounded bg-gray-900 p-4 font-mono text-gray-100">
      <div className="text-xs tracking-widest text-gray-500 mb-1">VALIDATION CENTER</div>
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="border border-gray-700 rounded bg-gray-950 p-3">
          <div className="text-[10px] tracking-widest text-gray-600 mb-1">CONFIDENCE</div>
          <div className="text-2xl font-bold text-white">{pct(validation.overall_confidence)}</div>
        </div>

        <div className="border border-gray-700 rounded bg-gray-950 p-3">
          <div className="text-[10px] tracking-widest text-gray-600 mb-1">AGREEMENT</div>
          <div className="text-2xl font-bold text-white">{pct(validation.agreement_score)}</div>
        </div>

        <div className="border border-gray-700 rounded bg-gray-950 p-3">
          <div className="text-[10px] tracking-widest text-gray-600 mb-1">TRUST SCORE</div>
          <div className="text-2xl font-bold text-white">{pct(validation.trust_score)}</div>
        </div>

        <div className="border border-gray-700 rounded bg-gray-950 p-3">
          <div className="text-[10px] tracking-widest text-gray-600 mb-1">CONTRADICTIONS</div>
      ...
      {validation.flags.length > 0 && (
        <div className="mt-2">
          <div className="text-[9px] tracking-widest text-gray-600/70 mb-1">FLAGS</div>
      ...
      {validation.evidence_summary && (
        <div className="mt-1.5">
          <div className="text-[9px] tracking-widest text-gray-600/70 mb-0.5">EVIDENCE</div>
          <div className="text-[11px] text-gray-400">{validation.evidence_summary}</div>
        </div>
      )}
    </div>
  );
